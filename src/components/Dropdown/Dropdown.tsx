...
const Dropdown = () => {
  ...
  const [hoverSelectedTab, setHoverSelectedTab] = useState(tabs[0]);
  ...
  return (
    <div className="flex-col sm:flex-row border-2 w-full flex justify-between sm:items-center" ref={scope}>
